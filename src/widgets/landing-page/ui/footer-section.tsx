        ...
        <div className="flex-1 flex items-center justify-center relative z-20">
          <div className="text-center">
            ...
            <div className="mt-10 flex flex-col items-center gap-[10px]">
              <Button className="py-8 px-6 bg-blue-900 border-2 border-white text-white text-[32px] font-semibold rounded-xl hover:bg-blue-700 hover:shadow-xl transition-all duration-300 hover:scale-105 shadow-[0_1px_2px_0_rgba(0,0,0,0.04)] mb-[88px]">
                Create My Resume
              </Button>
            </div>
          </div>
