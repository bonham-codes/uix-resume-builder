            ...
            item: [
              {
                ...
                children: [
                  ...
                  {
                    type: 'text',
                    text: { path: 'item.period', fallback: '2020 - Present' },
                    variant: 'small',
              ...
              {
                type: 'text',
                text: { path: 'item.company', fallback: 'Company' },
                variant: 'small',
                className: 'text-zinc-600',
              },
              {
                type: 'text',
                text: { path: 'item.description', fallback: 'What you did.' },
            ...
            children: [
              { type: 'text', text: 'Skills', variant: 'h3', weight: 'semibold' },
              {
                ...
                item: [
                  {
                    type: 'text',
                    text: { path: 'item', fallback: 'Skill' },
                    className: 'px-2 py-1 rounded bg-zinc-100 text-zinc-700 text-sm',
                  },
                ],
